                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logo/kk.png" alt="image"></a> </div>
                                        <p class="pb-20 text-white"><strong>Elevating Real Estate Experiences:</strong>

Welcome to [Verdera], your trusted partner in real estate. Our mission is to provide top-notch services, personalized to your unique needs. Whether you're buying, selling, or investing, we're here to make your real estate journey seamless and rewarding.</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Independent Layout phase 2, Enugu</li>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2023 Real Estate  - Ruhamahkamso</span> </div>
                    <div class="col-sm-6">
