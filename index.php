...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/Reserville.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Maximize Your Property's Potential with Our Expert Selling Service"</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Unlock a World of Possibilities with Our Rental Services"</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Your Dream Property Awaits in Our Listings</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Invest with Confidence - Legal Expertise at Your Service</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>"Excellence That Speaks Volumes:

                                        At [Verdera], our commitment to excellence has earned us a top-rated status in the real estate industry.
                                        </p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>"Crafting Quality Experiences, One Client at a Time:

                                        Quality is at the core of everything we do at [Verdera].
                                        </p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>"Navigating Real Estate with Seasoned Expertise:

                                        In the dynamic world of real estate, experience matters......
                                        </p>
									</div>
                                </li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>"Personalized Consultation for Your Unique Goals:
                                Embark on your real estate journey with a personalized discussion at [Verdera]
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>"Thorough File Review for a Smooth Process:

At [Verdera], we believe in meticulous attention to detail.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>"Seamless Acquisition for Your Real Estate Goals:

The moment you've been waiting for - the acquisition phase.</p>
                        </div>
                    </div>
                </div>
            </div>
